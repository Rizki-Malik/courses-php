...
--
-- Table structure for table `categories_course`
--
...
--
-- Indexes for table `categories_course`
--
ALTER TABLE `categories_course`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `categories_course`
--
ALTER TABLE `categories_course`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `article`
  ADD CONSTRAINT `article_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories_article` (`id`),
  ADD CONSTRAINT `article_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
ALTER TABLE `comments`
  ...
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`article_id`) REFERENCES `article` (`id`);

--
-- Constraints for table `courses`
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories_course` (`id`);
...
--
ALTER TABLE `course_reviews`
  ADD CONSTRAINT `course_reviews_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
...
--
ALTER TABLE `grades`
  ADD CONSTRAINT `grades_ibfk_1` FOREIGN KEY (`assignment_id`) REFERENCES `assignments` (`id`),
...
ALTER TABLE `likes`
  ...
  ADD CONSTRAINT `likes_ibfk_2` FOREIGN KEY (`article_id`) REFERENCES `article` (`id`);
